...
<body>
	<div>
		<form action="/CI/index.php/store/verify" method="post">
			信箱 : <input type="text" name="email"> <br>
			密碼 : <input type="password" name="passwd"> <br>
			<button class="myButton" type="submit">Submit</button>
			<button class="myButton" type="button"><a href="/CI/index.php/store/register">Sign up</a></button>
			<button class="myButton" type="button"><a href="/CI/index.php/store">Cancel</a></button>
	</form>
	</div>
