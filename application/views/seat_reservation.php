<html>
	...
	<body>
		<div><form>
			...
			<button id="submit" class="myButton">確認</button>
			<button class="myButton" type="button" onclick="window.location.replace('/CI/index.php/reservation');">回到大廳</button>
		</form></div>
		<script>
		$(document).ready(function(){
			$("#submit").click(function() {
				...
				$.ajax({
					url : "upload_seat_reservation",
					type : "POST",
					dataType : "text",
					data : {"date_" : $('#date_').val(), "time_" : $('#time_').val(), "quantity" : $('#quantity').val()},
